...
> Generiert von `scripts/change_ledger.py snapshot` (Base: `HEAD`, Stand: 2026-09-20 09:10 CEST).
...
| Status | Pfad | Art |
|---|---|---|
| ?? | docs/reports/current/2026-09-20_boundary_machinery_design_session.md | ungetrackt |
