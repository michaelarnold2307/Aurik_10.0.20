...
def run_gate(seconds: float = 1.6) -> tuple[object, list[DefectBenchmarkCaseResult]]:
    ...
    thresholds = DefectDetectionGateThresholds(
        ...
        max_runtime_factor=4.0,  # SOTA: deterministische Reproduzierbarkeit (§G5 (copilot-instructions.md)); clipping_locality THD-Analyse auf kurzen Segmenten kann >3× dauern
    )
