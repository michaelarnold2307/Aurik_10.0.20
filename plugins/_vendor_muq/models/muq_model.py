...
import os
# easydict ist eine optionale Abhängigkeit des Vendored-Codes — Minimal-Shim
# mit identischer Semantik, damit MuQ auch ohne pip-Paket importierbar bleibt
# (§V6 (copilot-instructions.md): nie blockierend).
try:
    from easydict import EasyDict
except ImportError:
    class EasyDict(dict):
        """Minimal-Shim für easydict.EasyDict (dict mit Attribut-Zugriff)."""
