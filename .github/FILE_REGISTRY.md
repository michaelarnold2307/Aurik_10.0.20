...
| backend/core/dsp/subspace_dereverb.py | PROTOTYP | backend/core/dsp | ja | — | §v10.756: Subspace-Dereverb (diffuser Floor + Wiener-Gain) — Tail-Reduktion nur 12 % im Synthese-Test; NICHT verdrahtet, Tail-Modell braucht Verfeinerung (§V7) (2026-09-09) |
...
| backend/core/dsp/phase_locked_vocoder.py | PROTOTYP | backend/core/dsp | ja | — | §v10.758: Phasen-verriegelter Vocoder (Lehrbuch-Laroche-Dolson) — Ton-Konzentrationstest schlägt fehl (0.000); NICHT verdrahtet, Debugging offen (§V7) (2026-09-09) |
