...
| backend/core/dsp/subspace_dereverb.py | PROTOTYP | backend/core/dsp | ja | — | §v10.756-Rebuild (2026-09-09): Late-Tail-Unterdrückung mit §v10.754-Floor als Tail-Prior — Suite grün (Tail −11.9 dB, Direkterhalt Korr 1.000 nach Einschwingen, Stille, Determinismus); NICHT verdrahtet (Verdrahtungs-Slice offen, §V7) |
...
| backend/core/dsp/phase_locked_vocoder.py | PROTOTYP | backend/core/dsp | ja | — | §v10.758/§v10.759-Rebuild (2026-09-09): Phasen-verriegelter Vocoder, STFT/OLA vollständig manuell — Suite grün (Konzentration 0.663, 220.0 Hz, RMS 0.707, keine Spikes, Determinismus); NICHT verdrahtet (Verdrahtungs-Slice offen, §V7) |
