...
| F4 | FlashSR-Musik | Checkpoint lokal (FastAudioSR-Quellbaum + upsampler.pth in models/flashsr) | Hochband-Rekonstruktion (aus ML-V1-VORAB: Kandidatenwahl) | MUSDB-HQ | ΔSDR ≥ +2 dB | **FINETUNE-HARNESS BEREIT 2026-09-17**: `scripts/train_flashsr_f4.py` (16-kHz-Basis → 48-kHz-Rekonstruktion, A1+MR-STFT, 132k Parameter, Smoke grün A1 0,003); Lauf SEQUENZIELL nach F3 (VRAM-Kollision vermieden) |
